...
import com.bbfw.common.util.IPUtils;
import com.bbfw.security.util.SecurityUtils;
import com.bbfw.system.model.entity.Log;
import com.bbfw.system.service.LogService;
...
public class LogAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.bbfw.common.annotation.Log)")
    ...
    public Object doAround(ProceedingJoinPoint joinPoint, com.bbfw.common.annotation.Log logAnnotation) throws Throwable {
     ...
     * @param userId        用户ID
     */
    private void saveLog(final JoinPoint joinPoint, final Exception e, Object jsonResult, com.bbfw.common.annotation.Log logAnnotation, long executionTime, Long userId) {
